...
\lstinputlisting{problems/listings/pointers_intro.cpp}
...
\lstinputlisting{problems/listings/pointers_intro_advanced.cpp}
...
\lstinputlisting{problems/listings/pointers_intro_validity.cpp}
}
...
\vbox{ %fixes empty page
\lstinputlisting{problems/listings/pointers_programm.cpp}
}
...
\lstinputlisting{problems/listings/pointers_behavior.cpp}

\paragraph{Mehrstufige Pointer}

Versuche nun das Gleiche mit den folgenden mehrstufigen Pointern.

\lstinputlisting{problems/listings/pointers_multi.cpp}
