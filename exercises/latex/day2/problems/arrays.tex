...
\lstinputlisting{problems/listings/arrays_intro.cpp}
...
\lstinputlisting{problems/listings/arrays_example.cpp}
...
\lstinputlisting{problems/listings/arrays_pointer.cpp}
...
\lstinputlisting{problems/listings/arrays_inc.cpp}

Somit kann man auf beliebige Elemente des Array über den Zeiger zugreifen:

\lstinputlisting{problems/listings/arrays_pointer_inc.cpp}
...
\lstinputlisting{problems/listings/arrays_sizeof.cpp}
...
\lstinputlisting{problems/listings/arrays_sizeof_pointer.cpp}
...
\lstinputlisting{problems/listings/arrays_printelems.cpp}
...
\lstinputlisting{problems/listings/arrays_iterate.cpp}
...
\lstinputlisting{problems/listings/arrays_iterate_end.cpp}
...
\lstinputlisting{problems/listings/arrays_print_with_index.cpp}
...
\lstinputlisting{problems/listings/arrays_heap.cpp}
...
\lstinputlisting{problems/listings/arrays_cin_size.cpp}
