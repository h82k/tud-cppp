\section{\ExercisePrefixMemory Verkettete Listen}
...
\begin{figure}[h]
\centering
\include{03_oo/figures/linkedlist}
\caption{Linked List}
\end{figure}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listitem.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listitem_private.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_list.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_intro.cpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_friend.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_inc.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_inc.cpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_methods.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_forward.hpp}
...
\lstinputlisting{02_memory/problems/listings/linkedLists_listiterator_iter.cpp}
