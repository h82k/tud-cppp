...
\lstinputlisting{04_advanced/problems/listings/callbacks_output.cpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_intro.cpp}

Nun können wir eine Funktion mit zwei Parametern an \lstinline{hanoi()} übergeben.

\lstinputlisting{04_advanced/problems/listings/callbacks_print.cpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_functor.cpp}

Dadurch kann an \lstinline{hanoi()} fast alles übergeben werden, was sich syntaktisch mittels

\lstinputlisting{04_advanced/problems/listings/callbacks_functor_func.hpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_functor_op.hpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_button.hpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_class_usage.cpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_base.hpp}
...
\lstinputlisting{04_advanced/problems/listings/callbacks_intpair.cpp}
