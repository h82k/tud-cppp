...
\lstinputlisting{problems/listings/overloading_vector.hpp}
...
\lstinputlisting{problems/listings/overloading_destructor.hpp}

und die Implementation entsprechend

\lstinputlisting{problems/listings/overloading_destructor_impl.cpp}
...
\lstinputlisting{problems/listings/overloading_operators.hpp}
...
\lstinputlisting{problems/listings/overloading_operators_impl.cpp}
...
\lstinputlisting{problems/listings/overloading_stdout.hpp}

und innerhalb der Sourcedatei wie folgt implementierst.

\lstinputlisting{problems/listings/overloading_stdout_impl.cpp}
...
\lstinputlisting{problems/listings/overloading_getter.hpp}

\paragraph{friend}
Füge die folgende Zeile am Ende der Klasse \texttt{Vector} hinzu:
\lstinputlisting{problems/listings/overloading_friend.hpp}
