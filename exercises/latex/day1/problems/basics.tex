...
\lstinputlisting{problems/listings/basics_types_intro.cpp}
...
\lstinputlisting{problems/listings/basics_types_ex.cpp}
...
\lstinputlisting{problems/listings/basics_stars.cpp}
...
\lstinputlisting{problems/listings/basics_starpattern.cpp}
...
\lstinputlisting{problems/listings/basics_printstars_sig.hpp}
...
\begin{itemize}
    ...
    \item{Mehrzeilige Kommentare müssen den folgenden Stil einhalten (beachte hierbei das zusätzliche \lstinline{*} in der ersten Zeile)\footnote{Es gibt noch andere Formate, aber wir werden hier in dem Praktikum den sogenannten JavaDoc-Style verwenden.}
		\lstinputlisting{problems/listings/basics_doxygen_comment.cpp}}
\end{itemize}
...
\lstinputlisting{problems/listings/basics_doxygen_example.hpp}
...
\lstinputlisting{problems/listings/basics_cin.cpp}
...
\lstinputlisting{problems/listings/basics_charpattern.cpp}
...
\lstinputlisting{problems/listings/basics_staticchar.cpp}
...
\lstinputlisting{problems/listings/basics_namespace_fun.cpp}
...
\lstinputlisting{problems/listings/basics_namespace_ref.cpp}
...
\lstinputlisting{problems/listings/basics_namespace_nested.cpp}
...
\lstinputlisting{problems/listings/basics_namespace_nested_ref.cpp}
