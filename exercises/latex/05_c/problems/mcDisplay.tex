...
\item 
Implementiere zur Ausgabe von Zahlen soll die Funktion \lstinline|writeNumberOnDisplay(uint16_t *value)|.
Verwende die Funktion \lstinline|itoa| (aus \filename{stdlib.h}), um den per Zeiger übergebenen Wert ein char-Array umzuwandeln.
Dazu wirst du einen Zeichenpuffer benötigen.
Gibt das Ergebnis anschließend mithilfe von \lstinline|writeText| auf dem Display aus.
\end{enumerate}
