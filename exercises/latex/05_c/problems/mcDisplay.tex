...
Abbildung \ref{fig:ascii57} zeigt den Aufbau der Daten im Array \lstinline|font| am Beispiel des Buchstabens A.
...
\hints {
    \item Falls du Sonderzeichen darstellen möchtest, kannst du dich an dieser Tabelle orientieren: \url{http://www.theasciicode.com.ar/american-standard-code-information-interchange/ascii-codes-table.png}. Um beispielsweise ein scharfes S auszugeben, definierst du es einfach als \lstinline{char ss = '\\xE1';}
}
