...
Benenne die Dateien \filename{blinkrainbow.h} und \filename{blinkrainbow.c} und lege sie im \filename{src}-Verzeichnis des Workspaces ab.

\item 
Klicke rechts auf die Gruppe \winIdeaGroupName{src}, wähle \menuPath{Add Files\dots} und füge die beiden neuen Dateien hinzu.
