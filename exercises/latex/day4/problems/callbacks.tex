...
\lstinputlisting{problems/listings/callbacks_output.cpp}
...
\lstinputlisting{problems/listings/callbacks_intro.cpp}

Nun können wir eine Funktion mit zwei Parametern an \lstinline{hanoi()} übergeben.

\lstinputlisting{problems/listings/callbacks_print.cpp}
...
\lstinputlisting{problems/listings/callbacks_functor.cpp}

Dadurch kann an \lstinline{hanoi()} fast alles übergeben werden, was sich syntaktisch mittels

\lstinputlisting{problems/listings/callbacks_functor_func.hpp}
...
\lstinputlisting{problems/listings/callbacks_functor_op.hpp}
...
\lstinputlisting{problems/listings/callbacks_button.hpp}
...
\lstinputlisting{problems/listings/callbacks_class_usage.cpp}
...
\lstinputlisting{problems/listings/callbacks_base.hpp}
...
\lstinputlisting{problems/listings/callbacks_intpair.cpp}
