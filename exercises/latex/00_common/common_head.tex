...
% #1 should be the name of the folder in exercises/solutions that contains the solution
\newcommand{\cpppSolutionName}[1]{Ein Lösungsvorschlag für diese Aufgabe liegt im Ordner \href{exercises/solutions/#1/.}{\texttt{./exercises/solutions/#1}}.}
