...
Benutze die erstellte Funktion \lstinline{printStars(int n)}, um eine weitere Funktion \lstinline{printFigure(int n)} zu schreiben, die eine Figur wie unten dargestellt ausgibt.
