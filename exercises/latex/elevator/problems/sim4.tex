...
\lstinputlisting{problems/listings/sim4_building.hpp}
\end{minipage}

\begin{minipage}[t]{.5\textwidth}
\lstinputlisting{problems/listings/sim4_building.cpp}
\end{minipage}
...
\lstinputlisting{problems/listings/sim4_tostring.cpp}
