...
Außerdem kann es verwendet werden, weitere Nebenaufgaben während der verschiedenen Compilationsphasen zu definieren, wie zum Beispiel das automatische Löschen der später unnötigen Compilationsdateien.
