...
\lstinputlisting{problems/listings/functional_intro_example}
...
\lstinputlisting{problems/listings/functional_map_example}
...
\lstinputlisting{problems/listings/functional_filter_example}
...
\lstinputlisting{problems/listings/functional_reduce_example}
...
\lstinputlisting{problems/listings/functional_map_sig}
...
\lstinputlisting{problems/listings/functional_filter_sig}

\subsubsection{\lstinline{reduce}}

Erstelle eine Funktion \lstinline{reduce}, die der folgenden Signatur folgt.

\lstinputlisting{problems/listings/functional_reduce_sig}
...
\lstinputlisting{problems/listings/functional_functor_square}

Die Funktion \lstinline{map} würde wie folgt umgeschrieben werden müssen.

\lstinputlisting{problems/listings/functional_functor_map}
