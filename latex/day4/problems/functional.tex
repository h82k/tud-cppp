...
\begin{itemize}
    ...
    \item In \ref{sec:map-filter-reduce-basic-impl} wirst du diese Funktionen deklarieren und in \Cref{sec:functional_impl_func} ausprogrammieren.
...
Implementiere in deinen Funktionen einen Templatetypen für die Funktionspointer/Funktoren und teste deinen Code sowohl mit Funktoren und Funktionen.
...
Unsere Klasse Square verändern wir dementsprechend zu
