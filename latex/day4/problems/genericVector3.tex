...
Um das zu ändern, muss du die Endung \texttt{*.tpp} an folgender Stelle registrieren: \textbf{Window -> Preferences -> General / Content Types -> Text / C Source File / C++ Source File}.
