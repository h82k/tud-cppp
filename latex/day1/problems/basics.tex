...
\begin{itemize}
    ...
    \item \lstinline{@fn Funktionsnamen} für den Namen der Funktion.
...
Eure Aufgabe ist es nun, den von euch erstellten Code sorgfältig zu dokumentieren. Die Dokumentation geschieht dabei nur in der \filename{.cpp} Datei, damit die \filename{.hpp} Datei möglichst kompakt bleibt.
