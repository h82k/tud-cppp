\PJi{Überall den Befehl \textbackslash filename verwenden.}
\PJi{Überall \textbackslash lstinline statt \textbackslash texttt einsetzen, wo sinnvoll (C-Code, Java-Code)}
...
Kommandozeile mit Hilfe von \lstinline{make} kompiliert werden, oder in Eclipse, indem du sie als Makefileprojekt importierst.
