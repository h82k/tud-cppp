...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{}l *5{|>{\centering\arraybackslash}X}@{}}
                    & \lstinline{int i} & \lstinline{int *j} & \lstinline{double k} & \lstinline{int **l} & \lstinline{const int *m} \\ \hline
        \lstinline{op1(int *)}          & \lstinline{\&x} & \lstinline{j} & \xmark & \listinline{*l} & \xmark \\ \hline
