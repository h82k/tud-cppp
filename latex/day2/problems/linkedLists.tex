...
\hints{
    ...
    \texttt{ListItem\& operator=(const ListItem \&other) = delete;}
}
...
Vergiss hier nicht, \texttt{operator<<} als \texttt{friend} von \texttt{List} zu deklarieren (wie zuvor bei \texttt{Vector}).
...
\paragraph{Zugriff von außen: ListIterator als friend-Klasse} Du wirst in den Methoden auf private Attribute der Liste zugreifen müssen. Um dies zu ermöglichen, könnte man öffentliche Getter für die Items der Liste schreiben.
