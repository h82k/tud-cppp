...
/* History:                                                                  */
/*                                                                           */
/* V1.10 2009-08-31 13:45:31 +0200 (Mon, 31 Aug 2009) rlande           3724  */
/* - removed: Dollar characters from versioning tag.                         */ 
/* - removed: Bit definitions from ADSR.                                     */ 
/* - renamed: VRCR_LPBM to VRCR_LPMB.                                        */ 
/*                                                                           */ 
/* V1.9  2008-09-12 10:31:35 +0200 (Fri, 12 Sep 2008) rlande           2392  */
/* - changed: PDR10, DDR10, PIER10, PILR10, EPILR10, PODR10, PUCR10, EPSR10, */
/*            ADECR, DSR, DSSR, DER                                          */
/* - removed: FMWC2, FMWC3, FMWC4                                            */
/* - added: EDSU2L, EDSU2H, ADER3, ADER4                                     */
/* - changed: Flash control registers (Flash A/B)                            */
/*                                                                           */
/* V1.8  2008-02-27 09:33:03 +0100 (Wed, 27 Feb 2008)  mwilla          1971  */
/* - Flash control registers changed (Flash A/B)                             */
/*                                                                           */
/* V1.7  2007-09-20 16:30:25 +0200 (Thu, 20 Sep 2007)  mwilla          1963  */
/* - Completely revised version                                              */
/*                                                                           */
/* V1.6  2007-05-15 11:53:07 +0200 (Tue, 15 May 2007)  meffen          1953  */
/* - added RTC                                                               */
/*                                                                           */
...
__IO_EXTENDED MCSRBSTR _mcsrb;  
#define MCSRB _mcsrb.byte
#define MCSRB_RDY _mcsrb.bit._RDY
#define MCSRB_RDYINT _mcsrb.bit._RDYINT
#define MCSRB_INTE _mcsrb.bit._INTE
#define MCSRB_WE _mcsrb.bit._WE
#define MCSRB_CRBE _mcsrb.bit._CRBE
#define MCSRB_DRBE _mcsrb.bit._DRBE
#define MCSRB_RD19V _mcsrb.bit._RD19V
__IO_EXTENDED MTCRBSTR _mtcrb;  
#define MTCRB _mtcrb.word
#define MTCRB_FAWC0 _mtcrb.bit._FAWC0
#define MTCRB_FAWC1 _mtcrb.bit._FAWC1
#define MTCRB_FAWC2 _mtcrb.bit._FAWC2
#define MTCRB_SYNC _mtcrb.bit._SYNC
#define MTCRB_ADS _mtcrb.bit._ADS
#define MTCRB_CLKBW _mtcrb.bit._CLKBW
#define MTCRB_WEXL _mtcrb.bit._WEXL
#define MTCRB_ATDINIT _mtcrb.bit._ATDINIT
#define MTCRB_ATDL0 _mtcrb.bit._ATDL0
#define MTCRB_ATDL1 _mtcrb.bit._ATDL1
#define MTCRB_ATDEQD0 _mtcrb.bit._ATDEQD0
#define MTCRB_ATDEQD1 _mtcrb.bit._ATDEQD1
#define MTCRB_EQL0 _mtcrb.bit._EQL0
#define MTCRB_EQL1 _mtcrb.bit._EQL1
#define MTCRB_EQL2 _mtcrb.bit._EQL2
#define MTCRB_FAWC _mtcrb.bitc._FAWC
#define MTCRB_ATDL _mtcrb.bitc._ATDL
#define MTCRB_ATDEQD _mtcrb.bitc._ATDEQD
#define MTCRB_EQL _mtcrb.bitc._EQL
__IO_EXTENDED MTCRBLSTR _mtcrbl;  
#define MTCRBL _mtcrbl.byte
#define MTCRBL_FAWC0 _mtcrbl.bit._FAWC0
#define MTCRBL_FAWC1 _mtcrbl.bit._FAWC1
#define MTCRBL_FAWC2 _mtcrbl.bit._FAWC2
#define MTCRBL_SYNC _mtcrbl.bit._SYNC
#define MTCRBL_ADS _mtcrbl.bit._ADS
#define MTCRBL_CLKBW _mtcrbl.bit._CLKBW
#define MTCRBL_WEXL _mtcrbl.bit._WEXL
#define MTCRBL_FAWC _mtcrbl.bitc._FAWC
__IO_EXTENDED MTCRBHSTR _mtcrbh;  
#define MTCRBH _mtcrbh.byte
#define MTCRBH_ATDINIT _mtcrbh.bit._ATDINIT
#define MTCRBH_ATDL0 _mtcrbh.bit._ATDL0
#define MTCRBH_ATDL1 _mtcrbh.bit._ATDL1
#define MTCRBH_ATDEQD0 _mtcrbh.bit._ATDEQD0
#define MTCRBH_ATDEQD1 _mtcrbh.bit._ATDEQD1
#define MTCRBH_EQL0 _mtcrbh.bit._EQL0
#define MTCRBH_EQL1 _mtcrbh.bit._EQL1
#define MTCRBH_EQL2 _mtcrbh.bit._EQL2
#define MTCRBH_ATDL _mtcrbh.bitc._ATDL
#define MTCRBH_ATDEQD _mtcrbh.bitc._ATDEQD
#define MTCRBH_EQL _mtcrbh.bitc._EQL
